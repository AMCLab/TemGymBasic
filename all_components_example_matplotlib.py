...
components = [AstigmaticLens(name='Astigmatic Lens', z=0.9),
              ...
              Deflector(name='Deflector', z=0.4, defx=0, defy=0),
...
for component in model.components:
    ...
    if component.type == 'Biprism':
        ...
        ax.plot([-r, -r/2], [z[idx], z[idx]],
                color='lightcoral', alpha=0.8, linewidth=component_lw, zorder=999)
        ax.plot([-r/2, 0], [z[idx], z[idx]],
                color='lightblue', alpha=0.8, linewidth=component_lw, zorder=999)
